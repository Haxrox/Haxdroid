...
/**
 * Build a URL call from a baseUrl and input;
 * specify an OutputFormat (for fetchResults).
...
/**
 * Return a Promise that downloads params.url, and
 * resolves the results (for formatResults).
 * @param {FetchParams} params
 * @return {Promise<FormatParams>}
 * @example
