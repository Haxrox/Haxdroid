...
const DESCRIPTION = 'Gets UBC course information';

const ORIGIN = 'https://courses.students.ubc.ca';
const BASE_URL = `${ORIGIN}/cs/courseschedule?pname=subjarea&tname=subj-course`;

/**
 * CourseInfo - gets UBC course information
 */
class CourseInfo extends SlashCommand {
  /**
...
module.exports = new CourseInfo(NAME, DESCRIPTION);
